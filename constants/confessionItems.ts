...
export const CONFESSION_GUIDE: ConfessionCategory[] = [
  {
    id: "credinta",
    title: "PĂCATE ÎMPOTRIVA CREDINȚEI ȘI VIEȚII DUHOVNICEȘTI",
    items: [
  ...
  {
    id: "blasfemie",
    title: "PĂCATE DE BLASFEMIE ȘI ÎNJURĂTURĂ",
    items: [
  ...
  {
    id: "duminica",
    title: "PĂCATE ÎMPOTRIVA DUMINICII ȘI SĂRBĂTORILOR",
    items: [
  ...
  {
    id: "aproapele",
    title: "PĂCATE ÎMPOTRIVA APROAPELUI",
    items: [
  ...
  {
    id: "parinti",
    title: "PĂCATE ÎMPOTRIVA PĂRINȚILOR ȘI FAMILIEI",
    items: [
  ...
  {
    id: "furt",
    title: "PĂCATE ALE FURTULUI ȘI NECINSTEI",
    items: [
  ...
  {
    id: "minciuna",
    title: "PĂCATE ALE MINCIUNII ȘI CALOMNIERII",
    items: [
  ...
  {
    id: "mandrie",
    title: "PĂCATE ALE MÂNDRIEI ȘI INVIDIEI",
    items: [
  ...
  {
    id: "lacomie",
    title: "PĂCATE ALE LĂCOMIEI ȘI BEȚIEI",
    items: [
