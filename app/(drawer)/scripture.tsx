...
import { MoreVertical, Menu } from 'lucide-react-native';
...
export default function ScriptureScreen() {
  ...
  // Verificăm dacă suntem pe acest ecran
  const isFocused = pathname.includes('scripture');
